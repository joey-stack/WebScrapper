...
- [ ] **Step 1: Write `generate_whatsapp_link(phone: str, name: str)` helper**
...
- [ ] **Step 2: Add `whatsapp_chat_link` to `process_and_qualify_dataframe`**
- [ ] **Step 3: Run dataset re-qualification and sync to Google Sheet**
...
- [ ] **Step 1: Write `execution/generate_pdf_proposal.py` script using `reportlab`**
- [ ] **Step 2: Test PDF generation for a sample lead**
...
- [ ] **Step 1: Enhance `parse_sender_accounts()` to scan `SENDER_EMAIL_1..5`**
- [ ] **Step 2: Test multi-account parsing and verification**
